export const PostPhoto= ({
    ...
    return <li className='Posts-list__item-block' key={`${id}${postTitle}`}>
        <ul className="Posts-list__item-block-list">
            <li className="Posts-list__item-block-list_item-author">
                <img className="author-image" src={authorImageUrl} alt="author image" />
            ...
            <li className="Posts-list__item-block-list_item-actions">
                <svg className="like-img" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill="#000000" height="800px" width="800px" version="1.1" id="Capa_1" viewBox="0 0 490 490" xmlSpace="preserve">
